...
const SPORT_GUIDES: Record<Sport, Record<WorkoutVerdict, Omit<SportGuide, "sport" | "displayName">>> = {
  basketball: {
    train_hard: {
...
export function getSportGuide(sport: Sport, verdict: WorkoutVerdict): SportGuide {
...
function buildReasoning(data: BiometricData, _verdict: WorkoutVerdict): string[] {
