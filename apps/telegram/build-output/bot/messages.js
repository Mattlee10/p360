...
Or try demo mode: /demo`,
    connectSuccess: (provider = "oura") => `✅ <b>${getProviderName(provider)} Connected!</b>

You can now use /workout to check your training readiness.

Try it now: /workout`,
    connectFailed: (provider = "oura") => `❌ <b>Connection Failed</b>
...
Try /demo for sample data`,
    status: (connected, lastCheck, provider) => {
        if (connected) {
